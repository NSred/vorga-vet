...
2. **Check what already exists** in `backend/tests/Application.UnitTests/{Feature}/` and `backend/tests/IntegrationTests/{Feature}/` — extend existing classes, don't duplicate.
